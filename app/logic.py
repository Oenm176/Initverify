...
APP_LIST_URL = "URL_GIST_ATAU_GITHUB_RAW_ANDA"  # <-- IMPORTANT: REPLACE WITH YOUR URL

# The URL to your online file containing the latest application version info.
VERSION_CHECK_URL = "URL_RAW_KE_FILE_VERSION_JSON_ANDA"  # <-- IMPORTANT: REPLACE WITH YOUR URL
